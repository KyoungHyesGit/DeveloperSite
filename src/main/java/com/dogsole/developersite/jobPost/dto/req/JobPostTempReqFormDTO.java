...
public class JobPostTempReqFormDTO {
    public JobPostTempReqFormDTO(Long id, String ip, String title, String detail, String work, String req, String salary, String zipcode, String streetAddr, String detailAddr, String extraAddr, LocalDateTime postDate, String state, String reqState, LocalDateTime endTime, LocalDateTime createDt, LocalDateTime updateDt, VenderReqDTO venderReqDTO) {
        this.id = id;
        this.ip = ip;
        this.title = title;
        this.detail = detail;
